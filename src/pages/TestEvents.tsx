...
// TEST PAGE: ICS URL Testing - shows copy/download functionality instead of redirecting
// Access at /test-events
    ...
    try {
      ...
      if (selectedEvents.size === 0) {
        ...
        if (redirectUri) {
          ...
          // TEST MODE: no redirect, just show message
          toast({
        ...
        {icsUrl && (
          ...
          >
            <label className="block text-sm font-medium text-foreground mb-2">
              Your Calendar Feed URL (Supabase)
            </label>
